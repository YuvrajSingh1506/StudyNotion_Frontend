...
export const fetchCourseDetails = async (courseId) => {
  ...
  try {
    ...
    // console.log("hwllkji ", response.data);
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    // console.log("result on creating section",response);
...
export const createSubSection = async (data, token) => {
  ...
  try {
    ...
    // console.log("At call result", result);
  } catch (error) {
...
export const updateSection = async (data, token) => {
  ...
  try {
    ...
    // console.log("result on updating section", response);
    result = response?.data?.data
  } catch (error) {
...
export const deleteSection = async (data, token) => {
  // console.log("at frontend delete option ", data)
  let result = null
  const toastId = toast.loading("Loading...")
  try {
