        ...
        <div className="grid mx-auto grid-cols-1 lg:grid-cols-4  mb-10 p-5 lg:w-fit">
            {
                LearningGridArray.map((card, index) =>(
                    ...
                    ${card.order % 2 === 1 ? "bg-richblack-700 lg:h-[280px] p-5" :card.order === -1 ?"bg-richblack-900 p-5":" bg-richblack-800  lg:h-[280px] p-5" }
                    ...
                    `
                    }>
                        {
                            ...
                            (<div className=" text-richblack-50  lg:w-[90%] flex flex-col p-5 gap-3 h-full ">
                                ...
                                <div className="w-fit">
                                     <CTAButton active = {true} className="w-fit" linkTo={card.BtnLink}>
                                    {card.BtnText}
                                </CTAButton>
                                </div>
                            </div>):
                            (<div className="flex flex-col gap-8 p-7" >
                                ...
                                <div className="text-richblack-300 text-md">
                                    {card.description}
                                </div>
                            </div>)
                        }
