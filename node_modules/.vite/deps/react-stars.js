...
//#endregion
//#region node_modules/react-stars/dist/react-stars.js
var require_react_stars = /* @__PURE__ */ __commonJSMin(((exports) => {
		...
		function ReactStars(props) {
			...
			_this.state = {
				...
				halfStar: {
					...
					hidden: props.half && props.value % 1 < .5
				}
			};
			_this.state.config = {
				count: props.count,
		...
		_createClass(ReactStars, [
			...
			},
			{
				...
				value: function componentWillReceiveProps(props) {
					this.setState({
						...
						halfStar: {
							at: Math.floor(props.value),
							hidden: this.state.config.half && props.value % 1 < .5
						}
					});
				}
			},
			...
			},
			{
				...
				value: function getRate() {
					var stars = void 0;
					if (this.state.config.half) stars = Math.floor(this.state.value);
					else stars = Math.round(this.state.value);
					return stars;
				}
			},
			{
				...
				value: function getStars(activeCount) {
					if (typeof activeCount === "undefined") activeCount = this.getRate();
					var stars = [];
					for (var i = 0; i < this.state.config.count; i++) stars.push({ active: i <= activeCount - 1 });
					return stars;
				}
			},
			{
				...
				value: function mouseOver(event) {
					...
					this.setState({ stars: this.getStars(index) });
				}
			},
			{
				key: "moreThanHalf",
			...
			},
			{
				...
				value: function renderHalfStarStyleElement() {
					...
					return _react2.default.createElement("style", { dangerouslySetInnerHTML: { __html: getHalfStarStyles(config.color2, uniqueness) } });
				}
			},
			{
				key: "renderStars",
				value: function renderStars() {
					...
					return stars.map(function(star, i) {
						var starClass = "";
						if (half && !halfStar.hidden && halfStar.at === i) starClass = "react-stars-" + uniqueness;
